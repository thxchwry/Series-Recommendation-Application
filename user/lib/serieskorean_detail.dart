...
class SeriesKoreanDetail extends StatefulWidget {
  final int id;
  final Color customPink = const Color.fromARGB(255, 233, 184, 215);

  const SeriesKoreanDetail({super.key, required this.id});

  @override
  State<StatefulWidget> createState() {
    return _SeriesKoreanDetailState();
  }
}

class _SeriesKoreanDetailState extends State<SeriesKoreanDetail> {
