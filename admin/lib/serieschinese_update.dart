...
class SeriesChineseUpdate extends StatefulWidget {
  final int id;

  const SeriesChineseUpdate({super.key, required this.id});

  @override
  State<StatefulWidget> createState() {
    return SeriesChineseUpdateState();
  }
}

class SeriesChineseUpdateState extends State<SeriesChineseUpdate> {
