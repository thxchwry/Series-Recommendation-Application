import 'package:admin/serieskoean_update.dart';
import 'package:flutter/material.dart';
import 'dart:convert';
import 'serieskorean_detail.dart';
import 'serieskorean_create.dart';
              ...
              children: [
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const SeriesKoreanCreate()),
            ...
            child: _series.isEmpty
                ? Center(
                    child: Column(
                      ...
                      children: [
                        Icon(Icons.movie_filter, size: 60, color: customPink.withOpacity(0.5)),
                                          ...
                                          Expanded(
                                            child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(
                                                  context,
                                                  MaterialPageRoute(builder: (context) => SeriesKoreanUpdate(id: series['id']))
                                                ).then((_) => _fetchSeries());
                                              },
                                              style: ElevatedButton.styleFrom(
