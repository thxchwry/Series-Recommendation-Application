import 'package:admin/serieskorean.dart';
import 'package:flutter/material.dart';
import 'dart:convert';
import 'package:http/http.dart' as http;

class SeriesKoreanUpdate extends StatefulWidget {
  final int id;

  const SeriesKoreanUpdate({super.key, required this.id});

  @override
  State<StatefulWidget> createState() {
    return SeriesKoreanUpdateState();
  }
}

class SeriesKoreanUpdateState extends State<SeriesKoreanUpdate> {
  ...
  Future<void> _fetchSeries() async {
    final url =
        Uri.parse('https://api-application-blond.vercel.app/serieskorean/${widget.id}');
  ...
  Future<void> _update() async {
    final url = Uri.parse('https://api-application-blond.vercel.app/serieskorean/');
    ...
    if (res.statusCode == 200 || res.statusCode == 201) {
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => const SeriesKorean()),
      );
    } else {
