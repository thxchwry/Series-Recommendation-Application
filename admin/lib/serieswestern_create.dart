...
class SeriesWesternCreate extends StatefulWidget {
  const SeriesWesternCreate({super.key});

  @override
  State<StatefulWidget> createState() {
    return SeriesWesternCreateState();
  }
}

class SeriesWesternCreateState extends State<SeriesWesternCreate> {
