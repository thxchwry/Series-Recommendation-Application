import 'package:admin/serieswestern_update.dart';
import 'package:flutter/material.dart';
import 'dart:convert';
import 'serieswestern_detail.dart';
import 'serieswestern_create.dart';
import 'package:http/http.dart' as http;


class SeriesWestern extends StatefulWidget {
  const SeriesWestern({super.key});

  @override
  State<StatefulWidget> createState() {
    return _SeriesWesternState();
  }
}

class _SeriesWesternState extends State<SeriesWestern> {
  ...
  Future<void> _fetchSeries() async {
    final response = await http.get(Uri.parse('https://api-application-blond.vercel.app/serieswestern'));
              ...
              children: [
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => const SeriesWesternCreate()),
                          ...
                          child: InkWell(
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => SeriesWesternDetail(id: series['id']),
                                ),
                              );
                            },
                            child: Column(
                                          ...
                                          Expanded(
                                            child: ElevatedButton(
                                              onPressed: () {
                                                Navigator.push(
                                                  context,
                                                  MaterialPageRoute(builder: (context) => SeriesWesternUpdate(id: series['id']))
                                                ).then((_) => _fetchSeries());
                                              },
                                              style: ElevatedButton.styleFrom(
