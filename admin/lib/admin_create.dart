...
class AdminCreateState extends State<AdminCreate> {
  ...
  Future<void> _create() async {
    try {
      final url = Uri.parse('https://api-application-blond.vercel.app/admin/');
      ...
      if (res.statusCode == 200 || res.statusCode == 201) {  
        _showSnackBar('Create admin success');  
        ...
        _showSnackBar('Error: ${res.statusCode} - Failed to creat');  
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Create Admin', style: TextStyle(fontWeight: FontWeight.bold)),
          ...
          child: Form(
            ...
            child: Column(children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'Email', // เปลี่ยน Label ตามคอนเทนต์
                  prefixIcon: Icon(Icons.email_rounded, color: customPink), // ใช้สไตล์ Icon แบบด้านบน
                  filled: true,
                  fillColor: Colors.grey[50],
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('SAVE ADMIN', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ),
              ),
