...
class SeriesChineseDetail extends StatefulWidget {
  final int id;
  final Color customPink = const Color.fromARGB(255, 233, 184, 215);

  const SeriesChineseDetail({super.key, required this.id});

  @override
  State<StatefulWidget> createState() {
    return _SeriesChineseDetailState();
  }
}

class _SeriesChineseDetailState extends State<SeriesChineseDetail> {
  ...
  Future<void> _fetchSeriesDetail() async {
    final response = await http.get(
        Uri.parse('https://api-application-blond.vercel.app/serieschinese/${widget.id}'));
    setState(() {
