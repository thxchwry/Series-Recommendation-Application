...
class SeriesKoreanCreate extends StatefulWidget {
  const SeriesKoreanCreate({super.key});

  @override
  State<StatefulWidget> createState() {
    return SeriesKoreanCreateState();
  }
}

class SeriesKoreanCreateState extends State<SeriesKoreanCreate> {
